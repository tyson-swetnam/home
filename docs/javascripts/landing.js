...
(function() {
  ...
  var PROJECTS = [
    ...
    { id: 'mesa', name: 'MESA', role: 'PI',
      funder: ['NSF 2632685'],
      summary: 'Multidisciplinary Environment for Scientific Advancement — agentic AI and community metadata standards that automatically describe and connect scientific data across fields. Built with ESIIL, NCEMS, AIIRA, and the Event Horizon Telescope.',
      href: 'https://www.nsf.gov/awardsearch/show-award/?AWD_ID=2632685', domains: ['ci','osci','genomics','ecology','agri','astro'],
      x: 0.66, y: 0.46, size: 18 },
